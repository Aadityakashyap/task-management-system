...
|-------|--------|-----------|-----------|----------|
| ![Login](https://github.com/Aadityakashyap/task-management-system/blob/task-management-system-fullstack/Screenshots/login.png) | ![SignUp](https://github.com/Aadityakashyap/task-management-system/blob/task-management-system-fullstack/Screenshots/signup.png) | ![Dashboard](https://github.com/Aadityakashyap/task-management-system/blob/task-management-system-fullstack/Screenshots/dashboard.png) | ![Create](https://github.com/Aadityakashyap/task-management-system/blob/task-management-system-fullstack/Screenshots/create.png) | ![Search/Sort](https://github.com/Aadityakashyap/task-management-system/blob/task-management-system-fullstack/Screenshots/search.png) |